...
const (
	create_rs_forwardingClass = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/forwardingclasss"
	read_rs_forwardingClass   = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/forwardingclasss/{name}"
	update_rs_forwardingClass = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/forwardingclasss/{name}"
	delete_rs_forwardingClass = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/forwardingclasss/{name}"
)
