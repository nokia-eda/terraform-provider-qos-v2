...
const (
	create_rs_policyDeployment = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/policydeployments"
	read_rs_policyDeployment   = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/policydeployments/{name}"
	update_rs_policyDeployment = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/policydeployments/{name}"
	delete_rs_policyDeployment = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/policydeployments/{name}"
)
