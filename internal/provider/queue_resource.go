...
const (
	create_rs_queue = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/queues"
	read_rs_queue   = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/queues/{name}"
	update_rs_queue = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/queues/{name}"
	delete_rs_queue = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/queues/{name}"
)
