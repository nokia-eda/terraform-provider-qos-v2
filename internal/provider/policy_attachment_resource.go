...
const (
	create_rs_policyAttachment = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/policyattachments"
	read_rs_policyAttachment   = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/policyattachments/{name}"
	update_rs_policyAttachment = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/policyattachments/{name}"
	delete_rs_policyAttachment = "/apps/qos.eda.nokia.com/v2/namespaces/{namespace}/policyattachments/{name}"
)
